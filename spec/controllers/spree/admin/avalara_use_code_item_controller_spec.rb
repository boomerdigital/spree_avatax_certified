...
describe Spree::Avalara::AvalaraUseCodeItemsController do
  describe "#index" do
  ...
  context "#show" do
    ...
    it "shows the use code of the id parameter" do
      use_code = Spree::Avalara::AvalaraUseCodeItem.create(use_code: "A", use_code_description: "Federal government")
